...
tags:
  - 10x程序员工作法
description: 你好，我是郑晔。 进入自动化这个模块，我准备从程序员的日常工作开始。介绍“[迭代0](http://time.geekbang.org/column/article/77294)”时，我提到构建脚本是项目准备的一个重要组成部分，但在那一讲中，我并没有具体说构建脚本长成什么样。 今天，我们以一个典型的...
author: HK意境
---
