...
tags:
  - MySQL
description: "在上一篇文章中，我和你介绍了 binlog 的基本内容，在一个主备关系中，每个备库接收主库的 binlog 并执行。 正常情况下，只要主库执行更新生成的所有 binlog，都可以传到备库并被正确地执行，备库就能达到跟主库一致的状态，这就是最终一致性。 但是，MySQL 要提供高可用能力，只有最..."
author: HK意境
---
...
![img](assets/89290bbcf454ff9a3dc5de42a85a69cc.png)
...
![img](assets/54f4c7c31e6f0f807c2ab77f78c8844a.png)
...
![img](assets/3786bd6ad37faa34aca25bf1a1d8af3a.png)
...
![img](assets/b8d2229b2b40dd087fd3b111d1bdda43.png)
...
![img](assets/553b7fc2d0dce3ec78bb595e1806eb8b.png)
...
![img](assets/cf5ea52aa3b26ef56c567125197fa171.png)
...
![img](assets/f968192ce2f436c939dd702b8f409771.png)
