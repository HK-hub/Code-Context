...
tags:
  - MySQL
description: "在 MySQL 里面，grant 语句是用来给用户赋权的。不知道你有没有见过一些操作文档里面提到，grant 之后要马上跟着执行一个 flush privileges 命令，才能使赋权语句生效。我最开始使用 MySQL 的时候，就是照着一个操作文档的说明按照这个顺序操作的。 那么，grant ..."
author: HK意境
---
...
![img](assets/7e75bbfbca0cb932e1256941c99d5f35.png)
...
![img](assets/32cd61ee14ad2f370e1de0fb4e39bb2e.png)
...
![img](assets/aea26807c8895961b666a5d96b081ac7.png)
...
![img](assets/9031814361be42b7bc084ad2ab2aa3ec.png)
...
![img](assets/dd625b6b4eb2dcbdaac73648a1af50f1.png)
