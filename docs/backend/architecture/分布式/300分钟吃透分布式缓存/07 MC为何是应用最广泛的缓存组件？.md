...
tags:
  - 300分钟吃透分布式缓存-完
description: 好，我是你的缓存老师陈波，欢迎你进入第 7 课时“Memcached 原理及特性”的学习。 众所周知，用户体验可以说是互联网企业最看重的指标，而在用户体验中，请求响应速度首当其冲。因此互联网系统对性能的追求是永无止境的。性能争霸，缓存为王，Memcached，作为互联网系统使用最广泛、影响最大的标配...
author: HK意境
order: 8
---
...
![img](https://learn.lianglianglee.com/专栏/300分钟吃透分布式缓存-完/assets/CgotOV2kTEyALjAgAADUQE7hy3o476.png)
