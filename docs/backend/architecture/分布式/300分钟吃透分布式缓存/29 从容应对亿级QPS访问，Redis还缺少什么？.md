---
title: 29 从容应对亿级QPS访问，Redis还缺少什么？
...
tags:
  - 300分钟吃透分布式缓存-完
description: 众所周知，Redis 在线上实际运行时，面对海量数据、高并发访问，会遇到不少问题，需要进行针对性扩展及优化。本课时，我会结合微博在使用 Redis 中遇到的问题，来分析如何在生产环境下对 Redis 进行扩展改造，以应对百万级 QPS。 对于线上较大流量的业务，单个 Redis 实例的内存占用很容易...
author: HK意境
order: 30
---
