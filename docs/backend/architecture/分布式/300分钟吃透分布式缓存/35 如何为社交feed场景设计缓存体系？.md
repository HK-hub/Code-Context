...
tags:
  - 300分钟吃透分布式缓存-完
description: 在上一课时我们讲解了如何为海量计数场景进行缓存设计，本课时中我将讲解如何为社交 Feed 场景设计缓存体系。 ![img](assets/Cgq2xl4LEmmAXJ3OAAEdlJkp5jU865.png) Feed 流是很多移动互联网系统的重要一环，如微博、微信朋友圈、QQ 好友动态、头条/抖音...
author: HK意境
order: 36
---
