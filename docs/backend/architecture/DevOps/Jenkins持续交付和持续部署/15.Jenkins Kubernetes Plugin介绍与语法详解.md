---
title: 15.Jenkins Kubernetes Plugin介绍与语法详解
...
tags:
  - Jenkins
description: 在上一节中介绍了jenkins使用不同的安装方式配置连接kubernetes集群的方法以及简单的示例，根据kubernetes插件用途的不同，对于插件语法的介绍也会区分开来，本节主要介绍一下使用kubernetes集群动态生成Jenkins slave pod的插件`Kubernetes plugi...
author: HK意境
order: 15
---
