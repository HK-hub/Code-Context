---
title: 12 Pod：如何理解这个Kubernetes里最核心的概念？
...
tags:
  - Kubernetes
description: 你好，我是Chrono。 前两天我们学习了Kubernetes世界里的工作语言YAML，还编写了一个简短的YAML文件，描述了一个API对象：Pod，它在spec字段里包含了容器的定义。 那么为什么Kubernetes不直接使用已经非常成熟稳定的容器？为什么要再单独抽象出一个Pod对象？为什么几乎所...
author: HK意境
order: 14
---
...
![图片](assets/0608d5d450c503c4102af27518d15bba.png)
...
![图片](assets/9ebab7d513a211a926dd69f7535ac175.png)
