...
tags:
  - Kubernetes
description: 你好，我是Chrono。 我们的课程学到了这里，你已经对Kubernetes有相当程度的了解了吧。 作为云原生时代的操作系统，Kubernetes源自Docker又超越了Docker，依靠着它的master/node架构，掌控成百上千台的计算节点，然后使用YAML语言定义各种API对象来编排调度容器...
author: HK意境
order: 36
---
...
![图片](assets/ecb1194e994c0a127d4818310dac14ab.png)
...
![图片](assets/12a28accca14eec348353521a89d4879.png)
...
![图片](assets/8ed5ba47b5bc6c6dc4b999415772deb5.png)

因为docker-compose在底层还是调用的Docker，所以它启动的容器用 `docker ps` 也能够看到：

![图片](assets/3c89d2d81c380a120d5d05617602c43e.png)
...
![图片](assets/5fab07a5ba4736a65380729ba392645f.png)
...
![图片](assets/c56a4bfdc87ce8cf945fa055997486d8.png)
...
![图片](assets/4c681530438eb50b1e2ba90c0c8de45e.png)
...
![图片](assets/e23953ca3dd05a79a660c7be9509c1b9.png)
...
![图片](assets/6019120aa14369ce6cb83e880382c1cb.png)
...
![图片](assets/db87232f578ea8556c452c2557db437d.png)
...
![图片](assets/2477f804c387b66d1f6188a2d7530947.jpg)