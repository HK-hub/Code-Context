...
tags:
  - Kubernetes
description: 你好，我是Chrono。 课程已经完结三个多月了，还记得结课时我说的那句话吗：“是终点，更是起点”，课程的完结绝不意味着我们终止对Kubernetes的钻研，相反，不论你我，都会在这个学习的道路上持续地走下去。 当初开课时，我计划了很多内容，不过Kubernetes的领域实在太广，加上我日常工作比较...
author: HK意境
order: 37
---
...
![图片](assets/8ed5086bb73d01ccdcd83deec1b8d643.png)
...
![图片](assets/252d80c9a08b7ddfccceb09a63b2da53.png)
...
![图片](assets/ee592a45c3b45c8335a2d1ae08bd73a6.png)
...
![图片](assets/967cbd227fc4aa8202b2531b59341f9e.png)
...
![图片](assets/e78c0c518c6257bc5018d0df8bd536d3.png)
...
![图片](assets/a00aea97b464f071e9bea603f5678ef5.png)
...
![图片](assets/60a4f01dd3bbb0afab4d142b1d232a32.png)
...
![图片](assets/a2d859927200ca449d9e50f6122e5705.png)
...
![图片](assets/7a00571f1c6ffc3391bda762206e74cc.png)
...
![图片](assets/16b663f31e55015a526791c22f6bcc3d.png)
...
![图片](assets/341506cde73d8b7a75eb6ee75ea77eyy.png)
...
![图片](assets/edc8b1307a7194935d2ccc96fb4bbe8d.png)
...
![图片](assets/36a25a182b0b1b671c1336a7b0610443.png)
...
![图片](assets/a6cc78271975de082c140a83e581b615.png)

你就会发现响应头里多出了几个字段，其中的 `RateLimit-*` 是限速信息，而 `Resp-New-Header` 就是新加的响应头字段。

把curl连续执行几次，就可以看到限速插件生效了：

![图片](assets/b2b321c8f7597c9ed151c2783af76282.png)
...
![图片](assets/e9c9050ebcd1d0fc001c53e1d75a37c8.jpg)