---
title: 25 PersistentVolume + NFS：怎么使用网络共享存储？
...
tags:
  - Kubernetes
description: 你好，我是Chrono。 在上节课里我们看到了Kubernetes里的持久化存储对象PersistentVolume、PersistentVolumeClaim、StorageClass，把它们联合起来就可以为Pod挂载一块“虚拟盘”，让Pod在其中任意读写数据。 不过当时我们使用的是HostPat...
author: HK意境
order: 27
---
