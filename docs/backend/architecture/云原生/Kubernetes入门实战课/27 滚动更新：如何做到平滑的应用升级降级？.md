...
tags:
  - Kubernetes
description: 你好，我是Chrono。 上次课里我们学习了管理有状态应用的对象StatefulSet，再加上管理无状态应用的Deployment和DaemonSet，我们就能在Kubernetes里部署任意形式的应用了。 不过，只是把应用发布到集群里是远远不够的，要让应用稳定可靠地运行，还需要有持续的运维工作。 ...
author: HK意境
order: 29
---
...
![图片](assets/15e17760079a03f046aa67f6e34b511e.png)
...
![图片](assets/20d23af1305e2d2b4f66b951c09dac52.png)
