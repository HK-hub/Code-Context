---
title: 11 YAML：Kubernetes世界里的通用语
...
tags:
  - Kubernetes
description: 你好，我是Chrono。 在上次课里，我们一起研究了Kubernetes的内部架构和组成，知道它分为控制面和数据面。控制面管理集群，数据面跑业务应用，节点内部又有apiserver、etcd、scheduler、kubelet、kube-proxy等组件，它们互相协作来维护整个集群的稳定运行。 这套...
author: HK意境
order: 13
---
...
![图片](assets/53cf783195be896e7632c1fc6bd24185.png)
