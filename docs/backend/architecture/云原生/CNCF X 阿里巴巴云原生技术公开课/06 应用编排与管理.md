...
tags:
  - CNCF
description: 首先，我们来看一下背景问题。如下图所示：如果我们直接管理集群中所有的 Pod，应用 A、B、C 的 Pod，其实是散乱地分布在集群中。 ![在这里插入图片描述](assets/b7c97640-d2c3-11e9-a365-2956af74956a) 现在有以下的问题： - 首先，如何保证集群内可用...
author: HK意境
order: 6
---
...
![avatar](assets/Fn-kTF85gQEi2Vkk8Jvqhyz2PgdI)

 
![avatar](assets/FtV6gw2MsQflGn8jprEnRwn8cTmg)
