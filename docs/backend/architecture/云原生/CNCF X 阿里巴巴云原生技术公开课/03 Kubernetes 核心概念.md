...
tags:
  - CNCF
description: Kubernetes，从官方网站上可以看到，它是一个工业级的容器编排平台。Kubernetes 这个单词是希腊语，它的中文翻译是“舵手”或者“飞行员”。在一些常见的资料中也会看到“ks”这个词，也就是“k8s”，它是通过将8个字母“ubernete ”替换为“8”而导致的一个缩写。 Kubernet...
author: HK意境
order: 3
---
...
![avatar](assets/FsUnrCguMgMBVyC1ybspBDgGg5tz)
...
![avatar](assets/FtQwOqpvCjmT_9MCtqS2IA0FhkKx)
...
![avatar](assets/Ft9Rf5hiHOSF5h0P0dz-RUVpq2Fs)

 
![avatar](assets/Fju4lrcck9azmN8uV1jHsk2NYM5d)
...
![avatar](assets/Flzm1OeSsGAqzkPS_l_SL8OWo99t)

 
![avatar](assets/FiyLMf6T0Q1Z-OAmAF7THSwsyIxG)
...
![avatar](assets/FlcotYqNLPbCvnibylrLt33enE1M)

Kubernetes 的 Master 包含四个主要的组件：API Server、Controller、Scheduler 以及 etcd。如下图所示：

![avatar](assets/FrFh4R6uKA2VDeclmHMZPxqTWbl_)
...
![avatar](assets/Fp29--O3Bo8y2VsC3C3SkwLILJ4-)
...
![avatar](assets/FsXK0GqTGIYAF9Vu5wndumZQlB7A)
...
![avatar](assets/FmFsx1ss6Nc01jifUhwW9NHW9W3_)
...
![avatar](assets/Fl18QUI1iine53dAy56-l4sErsLr)
...
![avatar](assets/FnD98YqsPIFP_5wKbyqD3Z7tKfOH)
...
![avatar](assets/Fqw4YYXdiHBS7TI2oFyCy55WVzP9)
...
![avatar](assets/FomVvOOmGfThgv1lQQ3d30d8v4aa)
...
![avatar](assets/Fp8roGITYZHjGDSiwrf3Q5zt7l1S)
...
![avatar](assets/FuUn6ZkhMD2b2UV6CY2jHYP8i450)
...
![avatar](assets/FlOUt7JuwbE0UBUz8NwA9vVYCuUl)

下一步我们利用 kubectl 来看一下这个集群中节选的状态，可以看到这个master 的节点已经是 running 状态：

![avatar](assets/FlT6wcXrdtsvhAnoiNWVFRVx1iiM)

我们就以这个为节点，下面我们尝试去看一下现在集群中 Deployment 这个资源：

![avatar](assets/FggAaOvw-U4UXQS7NMrcO3ew02X_)
...
![avatar](assets/FrqXKjDLgyIqN_vTsIlWt1ImrvxZ)

 
![avatar](assets/FpIjS0iNnlmx5GRpxdJFTcWlT1vo)

我们下面还是回到 kubectl 这个 commnd 来执行这次 Deployment 的真正的操作。我们可以看到一个简单的操作，就会去让 Deployment 不停地生成副本。

![avatar](assets/FlI67d3ZPrD37qNRdaNSrFE4xjfQ)
...
![avatar](assets/FuN37XsKiIT3WOYU5QNNIigMm1Ii)
...
![avatar](assets/Ft0eDGSed6lpc2TROivAJNV4wKpm)
