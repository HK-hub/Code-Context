...
tags:
  - CNCF
description: 本次课程的分享主要围绕以下五个部分： - 介绍一些整体需求的来源； - 介绍在 K8s 中 Liveness 和 Readiness 的使用方式； - 介绍在 K8s 中常见问题的诊断； - 应用的远程调试的方式； - 课程的总结与实践； 首先来看一下，整个需求的来源：当把应用迁移到 Kuberne...
author: HK意境
order: 11
---
