...
tags:
  - CNCF
description: 首先我们来思考一个问题：云原生应用是什么？ ![avatar](assets/FlGLRC6CFQW7Xqx5WQmgFXFkPxmh) 在生活中我们会和各种各样的应用打交道，有时候会在移动端上使用淘宝购物、使用高德导航，在 PC 端使用 word 编辑文稿、使用 Photoshop 处理相片···...
author: HK意境
order: 15
---
