...
tags:
  - CNCF
description: 现在来看第一个问题：为什么需要 Pod？我们知道 Pod 是 Kubernetes 项目里面一个非常重要的概念，也是非常重要的一个原子调度单位，但是为什么我们会需要这样一个概念呢？我们在使用容器 Docker 的时候，也没有这个说法。其实如果要理解 Pod，我们首先要理解容器，所以首先来回顾一下容器...
author: HK意境
order: 4
---
...
![avatar](assets/FtCLIkCogVpWbPlVEuyw-Qi1OgBV)
...
![avatar](assets/FnFxtuelVNca-K42uGiFCVShsJKp)
...
![avatar](assets/FhGvM2yWfWMEVfIXWnDGgGn45sh4)
...
![avatar](assets/FqzzX5i2imAnkOMeUQtiLkBal5wO)
...
![avatar](assets/FkuVM-7l2GEyyNjeBLBOTxpQ6TEQ)
...
![avatar](assets/FukG5VrC0Q7k4_5uB3vstrF687k8)
...
![avatar](assets/Ft6RFUZb1d6RwSUmzi2xWHPGUnNI)
...
![avatar](assets/Flqk0RrFG3EEh1pq4LTNOkhxlgM8)
...
![avatar](assets/FrYExOsbHoig5-2WLJByhSR25Z9n)
...
![avatar](assets/Fm6Z2IByCbIWWwpZCb8LVL9jLeOk)
...
![avatar](assets/FhxZpYP2nTou9k0ggnxZ_j6EYNvR)
...
![avatar](assets/Fs8v2oOG-5g0o9JoVkUrxgk1boRm)
...
![avatar](assets/FsSwJgFCqPpWQoebX5UY3a7zHHED)
...
![avatar](assets/FuVvWIzvVyBA_ugdQCMJUqqtrP2T)
