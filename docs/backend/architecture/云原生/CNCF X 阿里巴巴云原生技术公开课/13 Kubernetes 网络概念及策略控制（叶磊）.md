---
title: 13 Kubernetes 网络概念及策略控制（叶磊）
...
tags:
  - CNCF
description: 本文将主要分享以下 5 方面的内容： 1. Kubernetes 基本网络模型； 2. Netns 探秘； 3. 主流网络方案简介； 4. Network Policy 的用处； 5. 思考时间。 本节来介绍一下 Kubernetes 对网络模型的一些想法。大家知道 Kubernetes 对于网络具...
author: HK意境
order: 13
---
