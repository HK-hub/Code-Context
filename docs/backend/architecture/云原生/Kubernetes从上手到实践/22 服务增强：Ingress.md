...
tags:
  - Kubernetes
description: 通过前面的学习，我们已经知道 K8S 中有 `Service` 的概念，同时默认情况下还有 `CoreDNS` 完成集群内部的域名解析等工作，以此完成基础的服务注册发现能力。 在第 7 节中，我们介绍了 `Service` 的 4 种基础类型，在前面的介绍中，我们一般都在使用 `ClusterIP`...
author: HK意境
order: 22
---
