...
tags:
  - Kubernetes
description: 在第 3 节中，我们了解到 `kube-proxy` 的存在，而在第 7 中，我们学习到了如何将运行于 K8S 中的服务以 `Service` 的方式暴露出来，以供访问。 本节，我们来介绍下 `kube-proxy` 了解下它是如何支撑起这种类似服务发现和代理相关功能的。 `kube-proxy` ...
author: HK意境
order: 17
---
