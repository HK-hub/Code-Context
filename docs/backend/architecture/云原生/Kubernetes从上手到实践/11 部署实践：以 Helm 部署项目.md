...
tags:
  - Kubernetes
description: 上节，我们学习到了 Helm 的基础概念和工作原理，本节我们将 Helm 用于我们的实际项目，编写 Helm `chart` 以及通过 Helm 进行部署。 上节我们解释过 `chart` 的含义，现在我们要将项目使用 Helm 部署，那么首先，我们需要创建一个 `chart`。 在我们项目的根目录...
author: HK意境
order: 11
---
