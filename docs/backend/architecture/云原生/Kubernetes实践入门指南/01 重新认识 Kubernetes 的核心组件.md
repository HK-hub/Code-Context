---
title: 01 重新认识 Kubernetes 的核心组件
...
tags:
  - Kubernetes
description: 本篇我们开始介绍 Kubernetes 的核心组件，为了方便大家提前在脑中建立起完整的 Kubernetes 架构印象，笔者整理出核心组件的介绍如下： - kube-apiserver，提供了 Kubernetes 各类资源对象（Pod、RC、Service 等）的增删改查及 watch 等 HTT...
author: HK意境
order: 2
---
