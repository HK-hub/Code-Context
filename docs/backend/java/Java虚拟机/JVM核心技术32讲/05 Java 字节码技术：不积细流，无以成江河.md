---
title: 05 Java 字节码技术：不积细流，无以成江河
...
tags:
  - Jvm
description: Java 中的字节码，英文名为 `bytecode`, 是 Java 代码编译后的中间代码格式。JVM 需要读取并解析字节码才能执行相应的任务。 **从技术人员的角度看**，Java 字节码是 JVM 的指令集。JVM 加载字节码格式的 class 文件，校验之后通过 JIT 编译器转换为本地机器代...
author: HK意境
order: 5
---
...
![9f8bf31f-e936-47c6-a3d1-f0c0de0fc898.jpg](assets/poywn.jpg)
...
> ![1e17af1a-6b6b-4992-a75c-9eac959bc467.jpg](assets/te9bw.jpg)
...
> 算术操作码和类型
> ![30666bbb-50a0-4114-9675-b0626fd0167b.jpg](assets/58uua.jpg)

当我们想将 `int` 类型的值赋值给 `long` 类型的变量时，就会发生类型转换。

> 类型转换操作码
> ![e8c82cb5-6e86-4d52-90cc-40cde0fabaa0.jpg](assets/yzjfe.jpg)
