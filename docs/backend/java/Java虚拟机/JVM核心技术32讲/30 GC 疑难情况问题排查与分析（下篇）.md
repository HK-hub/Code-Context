...
tags:
  - Jvm
description: 另一类影响 GC 的问题是程序中的 non-strong 引用。虽然这类引用在很多情况下可以避免出现 [OutOfMemoryError](https://plumbr.eu/outofmemory)，但过量使用也会对 GC 造成严重的影响，反而降低系统性能。 首先，弱引用（weak referen...
author: HK意境
order: 30
---
