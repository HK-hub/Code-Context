---
title: 09 JDK 内置命令行工具：工欲善其事，必先利其器
...
tags:
  - Jvm
description: 很多情况下，JVM 运行环境中并没有趁手的工具，所以掌握基本的内置工具是一项基本功。 JDK 自带的工具和程序可以分为 2 大类型： 1. 开发工具 2. 诊断分析工具 写过 Java 程序的同学，对 JDK 中的开发工具应该比较熟悉。 下面列举常用的部分： | 工具 | 简介 | | --- | ...
author: HK意境
order: 9
---
