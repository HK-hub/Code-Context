...
tags:
  - Jvm
description: Java 程序的内存可以分为几个部分：堆（Heap space）、非堆（Non-Heap）、栈（Stack）等等，如下图所示： ![2459010.png](assets/b8e25a80-71db-11ea-964d-61a29639fe46) 最常见的 java.lang.OutOfMemory...
author: HK意境
order: 24
---
...
![40dddc4d-f192-40dc-9a1f-ab4df65d6f12.png](assets/d416dd70-71e1-11ea-b76f-3b9120f55521)
