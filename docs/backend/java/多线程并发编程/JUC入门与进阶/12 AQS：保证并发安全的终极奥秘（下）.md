...
tags:
  - Java
  - 并发
description: 我们在前几节课中学习了 ReentrantLock 或者 CountDownLatch 的 AQS 应用原理，本节将继续学习相比前两种稍微复杂一点的 ReentrantReadWriteLock。 它相对复杂的原因有以下几点： 1. ReentrantReadWriteLock 存在两种锁的形式，独...
author: HK意境
order: 12
---
