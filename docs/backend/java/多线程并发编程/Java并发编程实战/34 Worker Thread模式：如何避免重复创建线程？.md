...
tags:
  - Java
  - 并发
description: 在[上一篇文章](https://time.geekbang.org/column/article/95098)中，我们介绍了一种最简单的分工模式——Thread-Per-Message模式，对应到现实世界，其实就是委托代办。这种分工模式如果用Java Thread实现，频繁地创建、销毁线程非常影响...
author: HK意境
order: 37
---
...
![](assets/9d0082376427a97644ad7219af6922c3.png)
...
![](assets/f807b0935133b315870d2d7db5477db8.png)
...
![](assets/43c663eedd5b0b75b6c3022e26eb1583.png)
