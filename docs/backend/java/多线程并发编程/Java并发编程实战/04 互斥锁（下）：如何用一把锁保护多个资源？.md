...
tags:
  - Java
  - 并发
description: 在上一篇文章中，我们提到**受保护资源和锁之间合理的关联关系应该是N:1的关系**，也就是说可以用一把锁来保护多个资源，但是不能用多把锁来保护一个资源，并且结合文中示例，我们也重点强调了“不能用多把锁来保护一个资源”这个问题。而至于如何保护多个资源，我们今天就来聊聊。 当我们要保护多个资源时，首先要...
author: HK意境
order: 7
---
...
![](assets/1ba92a09d1a55a6a1636318f30c155d8.png)
...
![](assets/a46b4a1e73671d6e6f1bdb26f6c87627.png)
...
![](assets/527cd65f747abac3f23390663748da7c.png)
