...
tags:
  - Java
  - 并发
description: 实际工作中，我们总会难免和数据库打交道；只要和数据库打交道，就免不了使用数据库连接池。业界知名的数据库连接池有不少，例如c3p0、DBCP、Tomcat JDBC Connection Pool、Druid等，不过最近最火的是HiKariCP。 **HiKariCP号称是业界跑得最快的数据库连接池*...
author: HK意境
order: 44
---
...
![](assets/0b106876824e43d11750334e86556519.png)
...
![](assets/4b5e2ef70e46b087b139b331578a82a6.png)
