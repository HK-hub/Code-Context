---
title: 50 使用 Future 有哪些注意点？Future 产生新的线程了吗？
...
tags:
  - Java
  - 并发
description: 在本课时我们将讲解使用 Future 有哪些注意点，以及 Future 产生新的线程了吗？ **1. 当 for 循环批量获取 Future 的结果时容易 block，get 方法调用时应使用 timeout 限制** 对于 Future 而言，第一个注意点就是，当 for 循环批量获取 Futur...
author: HK意境
order: 51
---
