---
title: 65 CAS 和乐观锁的关系，什么时候会用到 CAS？
...
tags:
  - Java
  - 并发
description: 在本课时中，我将讲解 CAS 的应用场景，什么时候会用到 CAS？ Doug Lea 大神在 **JUC** 包中大量使用了 CAS 技术，该技术既能保证安全性，又不需要使用互斥锁，能大大提升工具类的性能。下面我将通过两个例子来展示 CAS 在并发容器中的使用情况。 先来看看并发容器 Concurr...
author: HK意境
order: 66
---
