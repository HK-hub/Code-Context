...
tags:
  - Java
  - 并发
description: 本课时我们介绍经典的哲学家就餐问题。 哲学家就餐问题也被称为刀叉问题，或者吃面问题。我们先来描述一下这个问题所要说明的事情，这个问题如下图所示： ![img](assets/Ciqah16ZbtKAZGebAAXzyFyJIXc351.png) 有 5 个哲学家，他们面前都有一双筷子，即左手有一根筷...
author: HK意境
order: 72
---
