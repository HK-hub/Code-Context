---
title: 12 有哪 6 种常见的线程池？什么是 Java8 的 ForkJoinPool？
...
tags:
  - Java
  - 并发
description: 在本课时我们主要学习常见的 6 种线程池，并详细讲解 Java 8 新增的 ForkJoinPool 线程池，6 种常见的线程池如下。 - FixedThreadPool - CachedThreadPool - ScheduledThreadPool - SingleThreadExecutor ...
author: HK意境
order: 13
---
