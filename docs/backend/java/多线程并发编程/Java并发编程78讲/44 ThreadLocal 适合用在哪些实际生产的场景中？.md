---
title: 44 ThreadLocal 适合用在哪些实际生产的场景中？
...
tags:
  - Java
  - 并发
description: 本课时主要介绍 ThreadLocal 适合用在哪些实际生产的场景中。 我们在学习一个工具之前，首先应该知道这个工具的作用，能带来哪些好处，而不是一上来就闷头进入工具的 API、用法等，否则就算我们把某个工具的用法学会了，也不知道应该在什么场景下使用。所以，我们先来看看究竟哪些场景下需要用到 Thr...
author: HK意境
order: 45
---
...
![img](assets/Cgq2xl5GbiiALuSeAADH1eeI90E061.png)
...
![img](assets/Cgq2xl5GbkGAepKRAAE5e9B5GbE065.png)
