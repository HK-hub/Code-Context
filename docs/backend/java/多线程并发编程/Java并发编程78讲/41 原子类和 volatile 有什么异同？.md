...
tags:
  - Java
  - 并发
description: 本课时我们主要讲解原子类和 volatile 有什么异同。 我们首先看一个案例。如图所示，我们有两个线程。 ![img](assets/CgpOIF49B7qAIJThAAB6qxJtvhs898.png) 在图中左上角可以看出，有一个公共的 boolean flag 标记位，最开始赋值为 true...
author: HK意境
order: 42
---
