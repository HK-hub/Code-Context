---
title: 17 如何正确关闭线程池？shutdown 和 shutdownNow 的区别？
...
tags:
  - Java
  - 并发
description: 在本课时我们主要学习如何正确关闭线程池？以及 shutdown() 与 shutdownNow() 方法的区别？首先，我们创建一个线程数固定为 10 的线程池，并且往线程池中提交 100 个任务，如代码所示。 ExecutorService service = Executors.newFixedT...
author: HK意境
order: 18
---
