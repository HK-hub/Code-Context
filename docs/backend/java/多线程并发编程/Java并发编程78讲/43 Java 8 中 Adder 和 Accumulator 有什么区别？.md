---
title: 43 Java 8 中 Adder 和 Accumulator 有什么区别？
...
tags:
  - Java
  - 并发
description: 本课时主要介绍在 Java 8 中 Adder 和 Accumulator 有什么区别。 我们要知道 Adder 和 Accumulator 都是 Java 8 引入的，是相对比较新的类。对于 Adder 而言，比如最典型的 LongAdder，我们在第 40 讲的时候已经讲解过了，**在高并发下 ...
author: HK意境
order: 44
---
