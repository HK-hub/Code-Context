---
title: 04 waitnotifynotifyAll 方法的使用注意事项？
...
tags:
  - Java
  - 并发
description: 本课时我们主要学习 wait/notify/notifyAll 方法的使用注意事项。 我们主要从三个问题入手： 1. 为什么 wait 方法必须在 synchronized 保护的同步代码中使用？ 2. 为什么 wait/notify/notifyAll 被定义在 Object 类中，而 sleep...
author: HK意境
order: 5
---
