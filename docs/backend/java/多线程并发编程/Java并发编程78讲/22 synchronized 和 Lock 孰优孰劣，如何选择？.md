---
title: 22 synchronized 和 Lock 孰优孰劣，如何选择？
...
tags:
  - Java
  - 并发
description: 本课时我们主要学习 synchronized 和 Lock 的异同点，以及该如何选择。 synchronized 和 Lock 的相同点非常多，我们这里重点讲解 3 个比较大的相同点。 - synchronized 和 Lock 都是用来保护资源线程安全的。 这一点毋庸置疑，这是它们的基本作用。 -...
author: HK意境
order: 23
---
