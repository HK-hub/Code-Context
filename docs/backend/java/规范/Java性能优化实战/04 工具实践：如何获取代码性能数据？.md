...
tags:
  - Java
  - 性能
description: 首先解答一下上一课时的问题。磁盘的速度这么慢，为什么 Kafka 操作磁盘，吞吐量还能那么高？ 这是因为，磁盘之所以慢，主要就是慢在寻道的操作上面。Kafka 官方测试表明，这个寻道时间长达 10ms。磁盘的顺序写和随机写的速度比，可以达到 6 千倍，Kafka 就是采用的顺序写的方式。 经过上一课...
author: HK意境
order: 5
---
...
![Drawing 1.png](assets/Ciqc1F8X2m6ABh9lAAqiFOnIMT0061.png)
...
![Drawing 2.png](assets/CgqCHl8X3PeAPufLAAPBFcBR8qY801.png)
