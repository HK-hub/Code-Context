...
tags:
  - Java
description: 今天，我们来聊聊使用连接池需要注意的问题。 在上一讲，我们学习了使用线程池需要注意的问题。今天，我再与你说说另一种很重要的池化技术，即连接池。 我先和你说说连接池的结构。连接池一般对外提供获得连接、归还连接的接口给客户端使用，并暴露最小空闲连接数、最大连接数等可配置参数，在内部则实现连接建立、连接心...
author: HK意境
order: 5
---
...
![img](assets/1685d9db2602e1de8483de171af6fd7e.png)
...
![img](assets/e72120b1f6daf4a951e75c05b9191a0f.png)
...
![img](assets/33a2389c20653e97b8157897d06c1510.png)
...
![img](assets/54a71ee9a7bbbd5e121b12fe6289aff2.png)

好在有了空闲连接回收的策略，60 秒之后连接处于 CLOSE_WAIT 状态，最终彻底关闭。

![img](assets/8ea5f53e6510d76cf447c23fb15daa77.png)
...
![img](assets/b79fb99cf8a5c3a17e60b0850544472d.png)
...
![img](assets/7b8f651755cef0c05ecb08727d315e35.png)

也就是说，每次都是新的 TCP 连接，放开 HTTP 这个过滤条件也可以看到完整的 TCP 握手、挥手的过程：

![img](assets/4815c0edd21d5bf0cae8c0c3e578960d.png)
...
![img](assets/2cbada9be98ce33321b29d38adb09f2c.png)
...
![img](assets/7b8e5aff5a3ef6ade1d8027c20c92f94.png)

使用 wrk 对应用进行压测，可以看到连接数一下子从 0 到了 10，有 20 个线程在等待获取连接：

![img](assets/b22169b8d8bbfabbb8b93ece11a1f9ef.png)
...
![img](assets/d24f23f05d49378a10a857cd8b9ef031.png)
