---
title: 06 2成的业务代码的Spring声明式事务，可能都没处理正确
...
tags:
  - Java
description: 今天，我来和你聊聊业务代码中与数据库事务相关的坑。 Spring 针对 Java Transaction API (JTA)、JDBC、Hibernate 和 Java Persistence API (JPA) 等事务 API，实现了一致的编程模型，而 Spring 的声明式事务功能更是提供了极其...
author: HK意境
order: 7
---
