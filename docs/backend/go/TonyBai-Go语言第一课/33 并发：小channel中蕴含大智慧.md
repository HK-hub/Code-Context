...
tags:
  - Tony
  - Bai
description: 你好，我是Tony Bai。 通过上两节课的学习，我们知道了Go语言实现了基于CSP（Communicating Sequential Processes）理论的并发方案。 Go语言的CSP模型的实现包含两个主要组成部分：一个是Goroutine，它是Go应用并发设计的基本构建与执行单元；另一个就是...
author: HK意境
order: 34
---
...
![图片](assets/cd4ae83c7a6740308bb9dbbd4d775819.jpg)
...
![图片](assets/1b11fa4261324de39c1722723187ccd4.jpg)
