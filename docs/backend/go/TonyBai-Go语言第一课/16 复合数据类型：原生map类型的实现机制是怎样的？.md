---
title: 16 复合数据类型：原生map类型的实现机制是怎样的？
...
tags:
  - Tony
  - Bai
description: 你好，我是Tony Bai。 上一节课，我们学习了Go语言中最常用的两个复合类型：数组与切片。它们代表**一组连续存储的同构类型元素集合。**不同的是，数组的长度是确定的，而切片，我们可以理解为一种“动态数组”，它的长度在运行时是可变的。 这一节课，我们会继续前面的脉络，学习另外一种日常Go编码中比...
author: HK意境
order: 17
---
...
![图片](assets/f818dcaf10cd42f1bb5d4049037f6f06.jpg)
...
![](assets/32d0f6b128b646fdb7d80af77d0f81d2.jpg)
...
![图片](assets/becf4c3571a04ceaafa7c26c4318af59.jpg)
...
![图片](assets/0de27d5e3bc34c10a04960b9249c0eba.jpg)
...
![图片](assets/bb51290ebd26427aa5d6bc389cabc01e.jpg)
...
![图片](assets/11cc9ceaac72450eae10a77b17ed1df2.jpg)
