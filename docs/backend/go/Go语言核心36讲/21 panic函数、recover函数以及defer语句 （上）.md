...
tags:
  - Go语言核心36讲
description: 我在上两篇文章中，详细地讲述了Go语言中的错误处理，并从两个视角为你总结了错误类型、错误值的处理技巧和设计方式。 在本篇，我要给你展示Go语言的另外一种错误处理方式。不过，严格来说，它处理的不是错误，而是异常，并且是一种在我们意料之外的程序异常。 这种程序异常被叫做panic，我把它翻译为运行时恐慌...
author: HK意境
order: 24
---
...
![](assets/606ff433a6b58510f215e57792822bd7.png)
