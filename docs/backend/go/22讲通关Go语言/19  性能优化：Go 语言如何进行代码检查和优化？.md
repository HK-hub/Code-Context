---
title: 19  性能优化：Go 语言如何进行代码检查和优化？
...
tags:
  - 22 讲通关 Go 语言-完
description: 在上节课中，我为你留了一个小作业：在运行 go test 命令时，使用 -benchmem 这个 Flag 进行内存统计。该作业的答案比较简单，命令如下所示： ➜ go test -bench=. -benchmem  ./ch18 运行这一命令就可以查看内存统计的结果了。这种通过 -benchme...
author: HK意境
order: 20
---
...
![19金句.png](assets/CgpVE1_sUrmATX3ZAAU9yqs6HjM626.png)
