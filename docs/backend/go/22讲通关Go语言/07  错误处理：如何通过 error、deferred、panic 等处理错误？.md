---
title: 07  错误处理：如何通过 error、deferred、panic 等处理错误？
...
tags:
  - 22 讲通关 Go 语言-完
description: 上节课我为你讲解了结构体和接口，并留了一个小作业，让你自己练习实现有两个方法的接口。现在我就以“人既会走也会跑”为例进行讲解。 首先定义一个接口 WalkRun，它有两个方法 Walk 和 Run，如下面的代码所示： type WalkRun interface { Walk() Run() } 现...
author: HK意境
order: 8
---
...
![pDE7ppQNyfRSIn1Q__thumbnail.png](assets/CgqCHl-15ZSAAsw5AAUnpsfN34w061.png)
