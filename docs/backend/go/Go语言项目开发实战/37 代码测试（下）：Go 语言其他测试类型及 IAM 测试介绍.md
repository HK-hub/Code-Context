---
title: 37 代码测试（下）：Go 语言其他测试类型及 IAM 测试介绍
...
tags:
  - Go 语言项目开发实战
description: 你好，我是孔令飞。 [上一讲](https://time.geekbang.org/column/article/408529)，我介绍了Go中的两类测试：单元测试和性能测试。在Go中，还有一些其他的测试类型和测试方法，值得我们去了解和掌握。此外，IAM项目也编写了大量测试用例，这些测试用例使用了不...
author: HK意境
order: 38
---
...
![图片](assets/53e09a0fc3f94b729152bd711de372ca.jpg)
