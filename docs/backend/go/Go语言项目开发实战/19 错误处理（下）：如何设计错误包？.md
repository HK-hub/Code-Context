...
tags:
  - Go 语言项目开发实战
description: 你好，我是孔令飞。 在Go项目开发中，错误是我们必须要处理的一个事项。除了我们上一讲学习过的错误码，处理错误也离不开错误包。 业界有很多优秀的、开源的错误包可供选择，例如Go标准库自带的`errors`包、`github.com/pkg/errors`包。但是这些包目前还不支持业务错误码，很难满足生...
author: HK意境
order: 20
---
...
![](assets/b144844f0a0a463f88fc2528e29abeae.jpg)
...
![](assets/1593f0704dd34c6491b4dd5cc6f41ac4.jpg)
