...
tags:
  - Go 语言项目开发实战
description: 你好，我是孔令飞。 在接下来的48讲，我会介绍如何基于腾讯云EKS来部署IAM应用。EKS其实是一个标准的Kubernetes集群，在Kubernetes集群中部署应用，需要编写Kubernetes资源的YAML（Yet Another Markup Language）定义文件，例如Service、...
author: HK意境
order: 48
---
...
![图片](assets/e933e6c931544178b1295fc7becf6722.jpg)
...
![图片](assets/948084c6067948fa86fd6a286eb511c6.jpg)
