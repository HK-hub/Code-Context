---
title: 22  Exchange 层剖析：彻底搞懂 Request-Response 模型（下）
...
tags:
  - Dubbo
description: 在上一课时中，我们重点分析了 Exchange 层中 Channel 接口以及 ChannelHandler 接口的核心实现，同时还介绍 Request、Response 两个基础类，以及 DefaultFuture 这个 Future 实现。本课时，我们将继续讲解 Exchange 层其他接口的实...
author: HK意境
order: 23
---
