---
title: 18  Buffer 缓冲区：我们不生产数据，我们只是数据的搬运工
...
tags:
  - Dubbo
description: Buffer 是一种字节容器，在 Netty 等 NIO 框架中都有类似的设计，例如，Java NIO 中的ByteBuffer、Netty4 中的 ByteBuf。Dubbo 抽象出了 ChannelBuffer 接口对底层 NIO 框架中的 Buffer 设计进行统一，其子类如下图所示： ![D...
author: HK意境
order: 19
---
