---
title: 09  Netty 入门，用它做网络编程都说好（上）
...
tags:
  - Dubbo
description: 了解 Java 的同学应该知道，JDK 本身提供了一套 NIO 的 API，但是这一套原生的 API 存在一系列的问题。 - **Java NIO 的 API 非常复杂。** 要写出成熟可用的 Java NIO 代码，需要熟练掌握 JDK 中的 Selector、ServerSocketChanne...
author: HK意境
order: 10
---
