---
title: 26  加餐：直击 Dubbo “心脏”，带你一起探秘 Invoker（上）
...
tags:
  - Dubbo
description: 在前面课时介绍 DubboProtocol 的时候我们看到，上层业务 Bean 会被封装成 Invoker 对象，然后传入 DubboProtocol.export() 方法中，该 Invoker 被封装成 DubboExporter，并保存到 exporterMap 集合中缓存。 在 DubboP...
author: HK意境
order: 27
---
