---
title: 20  Transporter 层核心实现：编解码与线程模型一文打尽（下）
...
tags:
  - Dubbo
description: 在上一课时中，我们深入分析了 Transporter 层中 Server 相关的核心抽象类以及基于 Netty 4 的实现类。本课时我们继续分析 Transporter 层中剩余的核心接口实现，主要涉及 Client 接口、Channel 接口、ChannelHandler 接口，以及相关的关键组件...
author: HK意境
order: 21
---
