---
title: 34  加餐：初探 Dubbo 动态配置的那些事儿
...
tags:
  - Dubbo
description: 在前面第 31 课时中我们详细讲解了 RegistryDirectory 相关的内容，作为一个 NotifyListener 监听器，RegistryDirectory 会同时监听注册中心的 providers、routers 和 configurators 三个目录。通过 RegistryDire...
author: HK意境
order: 35
---
