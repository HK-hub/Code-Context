---
title: 30  Filter 接口，扩展 Dubbo 框架的常用手段指北
...
tags:
  - Dubbo
description: 在前面的第 27 课时中，我们介绍了 ProtocolFilterWrapper 的具体实现，这里简单回顾一下。在 buildInvokerChain() 方法中，ProtocolFilterWrapper 会加载 Dubbo 以及应用程序提供的 Filter 实现类，然后构造成 Filter 链，...
author: HK意境
order: 31
---
