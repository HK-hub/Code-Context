...
tags:
  - Kafka
description: 在专栏上一期中，我们谈了Kafka当前的定位问题，Kafka不再是一个单纯的消息引擎系统，而是能够实现精确一次（Exactly-once）处理语义的实时流处理平台。 你可能听说过Apache Storm、Apache Spark Streaming抑或是Apache Flink，它们在大规模流处理领...
author: HK意境
order: 5
---
...
![](assets/0ecc8fe201c090e7ce514d719372f43d.png)
...
![](assets/a2ec80dceb9ba6eeaaeebc662f439211.jpg)
