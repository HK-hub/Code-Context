...
tags:
  - Kafka
description: 你好，我是胡夕。今天我要和你分享的主题是：Kafka的消费者组。 消费者组，即Consumer Group，应该算是Kafka比较有亮点的设计了。那么何谓Consumer Group呢？用一句话概括就是：**Consumer Group是Kafka提供的可扩展且具有容错性的消费者机制**。既然是一个...
author: HK意境
order: 16
---
...
![](assets/b3b0a5917b03886d31db027b466200c0.jpg)
...
![](assets/60478ddbf101b19a747d8110ae019ef5.jpg)
