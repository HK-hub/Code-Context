...
tags:
  - Kafka
description: 你好，我是胡夕。今天我要和你分享的主题是：客户端都有哪些不常见但是很高级的功能。 既然是不常见，那就说明在实际场景中并没有太高的出场率，但它们依然是很高级很实用的。下面就有请今天的主角登场：Kafka拦截器。 如果你用过Spring Interceptor或是Apache Flume，那么应该不会对...
author: HK意境
order: 13
---
...
![](assets/096831a3ba037b3f9e507e6db631d3c4.png)
...
![](assets/f2cbe18428396aab14749be10dc5550d.jpg)
