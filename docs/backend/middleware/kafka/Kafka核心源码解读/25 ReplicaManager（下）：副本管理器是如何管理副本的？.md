---
title: 25 ReplicaManager（下）：副本管理器是如何管理副本的？
...
tags:
  - Kafka
description: 你好，我是胡夕。 上节课我们学习了ReplicaManager类源码中副本管理器是如何执行副本读写操作的。现在我们知道了，这个副本读写操作主要是通过appendRecords和fetchMessages这两个方法实现的，而这两个方法其实在底层分别调用了Log的append和read方法，也就是我们在...
author: HK意境
order: 28
---
...
![](assets/20298371601540a21da0ec5b1a6b1896.jpg)
...
![](assets/053b8eb9c4bb0342398ce9650b37aa25.png)
...
![](assets/b2dee2575c773afedcf6ee7ce00c7b88.jpg)
...
![](assets/0ce6b2e29byyfd4db331e65df6b8bb3e.jpg)
...
![](assets/b63ecd5619213340df68f0771607f6f2.jpg)
