---
title: 13 ControllerEventManager：变身单线程后的Controller如何处理事件？
...
tags:
  - Kafka
description: 你好，我是胡夕。 今天，我们来学习下Controller的单线程事件处理器源码。 所谓的单线程事件处理器，就是Controller端定义的一个组件。该组件内置了一个专属线程，负责处理其他线程发送过来的Controller事件。另外，它还定义了一些管理方法，用于为专属线程输送待处理事件。 在0.11....
author: HK意境
order: 16
---
...
![](assets/67fbf8a12ebb57bc309188dcbc18e231.jpg)
...
![](assets/a4bd821a8fac58bdf9c813379bc28e63.jpg)
...
![](assets/1137cfd21025c797369fa3d39cee5d4b.jpg)
...
![](assets/db4905db1a32ac7d356317f29d920dd1.jpg)
...
![](assets/4ec79e1ff2b83d0a1e850b6acf30b226.jpg)
