...
tags:
  - ElasticSearch
description: 如前文所述，查询分基于文本查询和基于词项的查询: ![img](assets/es-dsl-full-text-3.png) 本文主要讲基于词项的查询。 ![img](assets/es-dsl-term-1.png) > 很多比较常用，也不难，就是需要结合实例理解。这里综合官方文档的内容，我设计一...
author: HK意境
order: 9
---
