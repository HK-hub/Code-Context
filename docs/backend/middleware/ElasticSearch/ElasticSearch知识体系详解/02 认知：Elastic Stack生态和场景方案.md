---
title: 02 认知：Elastic Stack生态和场景方案
...
tags:
  - ElasticSearch
description: > Beats + Logstash + ElasticSearch + Kibana 如下是我从官方博客中找到图，这张图展示了ELK生态以及基于ELK的场景（最上方） ![img](assets/es-introduce-1-1.png) 由于Elastic X-Pack是面向收费的，所以我们不妨...
author: HK意境
order: 2
---
