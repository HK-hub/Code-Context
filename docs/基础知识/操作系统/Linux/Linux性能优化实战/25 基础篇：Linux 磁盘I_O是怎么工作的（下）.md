---
title: 25 基础篇：Linux 磁盘I_O是怎么工作的（下）
...
tags:
  - 性能
description: 你好，我是倪朋飞。 上一节我们学习了 Linux 磁盘 I/O 的工作原理，并了解了由文件系统层、通用块层和设备层构成的 Linux 存储系统 I/O 栈。 其中，通用块层是 Linux 磁盘 I/O 的核心。向上，它为文件系统和应用程序，提供访问了块设备的标准接口；向下，把各种异构的磁盘设备，抽象...
author: HK意境
order: 26
---
...
![](assets/0122db0b86ba4a6684ad0da76336a176.jpg)
