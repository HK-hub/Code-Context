...
tags:
  - 性能
description: 你好，我是倪朋飞。 前几节我们一起学习了 CPU 的性能原理和优化方法，接下来，我们将进入另一个板块——内存。 同 CPU 管理一样，内存管理也是操作系统最核心的功能之一。内存主要用来存储系统和应用程序的指令、数据、缓存等。 那么，Linux 到底是怎么管理内存的呢？今天，我就来带你一起来看看这个问...
author: HK意境
order: 16
---
...
![](assets/370131811a754d88b210ce7bba88a908.jpg)
...
![](assets/945254998d06437da9de7756e5d61507.jpg)
...
![](assets/d5a520c204a6438a95abc520ac2701d1.jpg)
...
![](assets/6372323009c840e8829a4ac046c1425f.jpg)
