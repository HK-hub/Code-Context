...
tags:
  - Linux
description: 你好，我是邵亚方。这节课我来跟大家分享TCP拥塞控制与业务性能抖动之间的关系。 TCP拥塞控制是TCP协议的核心，而且是一个非常复杂的过程。如果你不了解TCP拥塞控制的话，那么就相当于不理解TCP协议。这节课的目的是通过一些案例，介绍在TCP拥塞控制中我们要避免踩的一些坑，以及针对TCP性能调优时需...
author: HK意境
order: 14
---
...
![](assets/5c4504d70ce3abc939yyca54780dd43c.jpg)
...
![](assets/0534ce8d1e3a09a1def9c27e387eb64d.jpg)
...
![](assets/0c2ce093d74a1dc76f39b7cbdd386699.jpg)
...
![](assets/e920b93740d9677c5419dee332086827.jpg)
