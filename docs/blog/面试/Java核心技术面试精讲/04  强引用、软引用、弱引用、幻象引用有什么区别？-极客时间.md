---
title: 04  强引用、软引用、弱引用、幻象引用有什么区别？-极客时间
...
tags:
  - Java
description: 在 Java 语言中，除了原始数据类型的变量，其他所有都是所谓的引用类型，指向各种不同的对象，理解引用对于掌握 Java 对象生命周期和 JVM 内部相关机制非常有帮助。 今天我要问你的问题是，**强引用、软引用、弱引用、幻象引用有什么区别？具体使用场景是什么？** 不同的引用类型，主要体现的是**...
author: HK意境
order: 5
---
...
![](assets/36d3c7b158eda9421ef32463cb4d4fb0-20221026231642-qgqprs2.png)
...
![](assets/bae702d46c665e12113f5abd876eb53e-20221026231642-gx8za9u.png)
