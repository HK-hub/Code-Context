---
title: 03  谈谈final、finally、 finalize有什么不同？-极客时间
...
tags:
  - Java
description: Java 语言有很多看起来很相似，但是用途却完全不同的语言要素，这些内容往往容易成为面试官考察你知识掌握程度的切入点。 今天，我要问你的是一个经典的 Java 基础题目，**谈谈 final、finally、 finalize 有什么不同？** final 可以用来修饰类、方法、变量，分别有不同的意...
author: HK意境
order: 4
---
