---
title: 00 开篇词  以面试题为切入点，有效提升你的Java内功-极客时间
...
tags:
  - Java
description: Java 是一门历史悠久的编程语言，可以毫无争议地说，Java 是最主流的编程语言之一。全球有 1200 万以上 Java 程序员以及海量的设备，还有无所不能的 Java 生态圈。 我所知道的诸如阿里巴巴、京东、百度、腾讯、美团、去哪儿等互联网公司，基本都是以 Java 为首要编程语言的。即使在最新...
author: HK意境
order: 1
---

# 00 开篇词  以面试题为切入点，有效提升你的Java内功-极客时间
