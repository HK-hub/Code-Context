---
title: 07  int和Integer有什么区别？-极客时间
...
tags:
  - Java
description: Java 虽然号称是面向对象的语言，但是原始数据类型仍然是重要的组成元素，所以在面试中，经常考察原始数据类型和包装类等 Java 语言特性。 今天我要问你的问题是，**int 和 Integer 有什么区别？谈谈 Integer 的值缓存范围。** int 是我们常说的整形数字，是 Java 的 8...
author: HK意境
order: 8
---
