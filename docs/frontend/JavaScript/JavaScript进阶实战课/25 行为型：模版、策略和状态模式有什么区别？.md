...
tags:
  - Java
description: 你好，我是石川。 今天我们来说说设计模式中剩下的几种行为型模式。我个人觉得剩下这六种模式可以大致分为两类，一类是偏向“策略模型”的设计模式，这里包含了策略、状态和模版这三种模式。另外一大类是偏向“数据传递”的设计模式，这里就包含了中介、命令和职责链这几种模式。这些类别的模式，有什么共同和不同呢？我们...
author: HK意境
order: 26
---
...
![图片](assets/8520c48185094ecfb506958255ffa2bf.jpg)
...
![图片](assets/3313697e646a42ffb4c6fcdef9558f33.jpg)
...
![图片](assets/cd19e948cbc54075aea2d62d42877eb5.jpg)
...
![图片](assets/1f35c4d9a9ec476dbccb9551e11f6f27.jpg)
...
![图片](assets/88e43d4ba9ea4e75af52fdef01efe7b0.jpg)
...
![图片](assets/e64bbc7412254da2be7a93a6d26ecbf2.jpg)
