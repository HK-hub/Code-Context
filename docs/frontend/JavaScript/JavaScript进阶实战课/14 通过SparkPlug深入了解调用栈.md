...
tags:
  - Java
description: 你好，我是石川。 在[第11讲](https://time.geekbang.org/column/article/580014)的时候，我们通过函数中的闭包了解了栈和堆这两种数据结构。在[12讲](https://time.geekbang.org/column/article/580442)中，...
author: HK意境
order: 15
---
