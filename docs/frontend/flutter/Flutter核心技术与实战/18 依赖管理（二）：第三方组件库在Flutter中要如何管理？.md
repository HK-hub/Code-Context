...
tags:
  - Flutter
description: 你好，我是陈航。 在上一篇文章中，我与你介绍了Flutter工程的资源管理机制。在Flutter中，资源采用先声明后使用的机制，在pubspec.yaml显式地声明资源路径后，才可以使用。 对于图片，Flutter基于像素密度，设立不同分辨率的目录分开管理，但只需要在pubspec.yaml声明一次...
author: HK意境
order: 19
---
...
![](assets/cd7a22dbaf304e7ca6e4e7e3919f68a0.jpg)
...
![](assets/9f77c5091c594075918405c008dfcefa.jpg)
