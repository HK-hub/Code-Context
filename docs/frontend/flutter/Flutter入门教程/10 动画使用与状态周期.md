...
tags:
  - Flutter
description: 接下来，我们将进入猜数字项目的最后一个模块：动画的使用。上一节末尾说了，此处使用动画的目的是 **增加交互反馈效果** 。动画本质上就是不断更新界面展示的内容，玩过翻页动画的感触会深一些: > 在每页纸上绘制连续的动作，手快速翻动时，内容快速变化，形成连续运动的动画效果。 ![image.png](...
author: HK意境
order: 10
---
...
> 当前代码提交位置: [result_notice.dart](https://github.com/toly1994328/flutter_first_station/blob/88f535f3e8575fefa5e465f2135956bd28356451/lib/guess/result_notice.dart)
...
> 当前代码提交位置: [result_notice.dart](https://github.com/toly1994328/flutter_first_station/blob/a2d2b18c1f786e1438911abf42f5e996ade88ad7/lib/guess/result_notice.dart)
